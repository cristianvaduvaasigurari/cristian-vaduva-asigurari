        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24 max-w-6xl mx-auto">
            ...
            <div className="glass beneficiu-card p-10 rounded-[3rem] border border-border text-center">
              ...
              <p className="text-muted-foreground">Acces la o rețea extinsă de proprietăți în capitalele financiare ale lumii și destinații beneficiu.</p>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center mb-24 p-12 glass rounded-[3rem] border border-amber-500/20 relative overflow-hidden">
            ...
            <p className="text-lg text-muted-foreground relative z-10">
              AiXbeneficiu nu este o simplă agenție. Este un Private Club pentru investitori imobiliari. 
