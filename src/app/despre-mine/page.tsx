  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 pt-32 pb-16">
        ...
        <div className="container mx-auto px-4 max-w-6xl mb-24">
          <div className="flex flex-col md:flex-row items-center gap-16">
            ...
            <div className="flex-1 relative">
              <div className="aspect-[4/5] rounded-[3rem] overflow-hidden relative glass border border-white/10">
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent z-10" />
                {/* Fallback pattern / gradient if no image */}
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-blue-900/40 via-background to-background" />
        ...
        {/* Core Expertise */}
        <div className="bg-black/50 border-y border-white/5 py-24 mb-24">
        ...
        <div className="container mx-auto px-4 max-w-4xl mb-24">
          <div className="prose prose-invert max-w-none">
            ...
            <div className="grid md:grid-cols-2 gap-12 mt-16">
              <div>
                <h3 className="text-xl font-bold mb-4 font-heading text-white">Ce mă definește?</h3>
                <ul className="space-y-4 text-muted-foreground">
                  <li className="flex gap-3"><span className="text-blue-500">◆</span> Transparență totală în auditarea riscului.</li>
                  <li className="flex gap-3"><span className="text-blue-500">◆</span> Acces la rețele private (Off-market properties).</li>
                  <li className="flex gap-3"><span className="text-blue-500">◆</span> Eficiența capitalului (blocarea riscurilor prin polițe, nu prin cash).</li>
                </ul>
              </div>
              <div>
                <h3 className="text-xl font-bold mb-4 font-heading text-white">Pentru cine sunt?</h3>
                <ul className="space-y-4 text-muted-foreground">
                  <li className="flex gap-3"><span className="text-emerald-500">◆</span> Antreprenori și proprietari de IMM-uri.</li>
