...
const resources = [
  ...
  { id: "guide-business", title: "Ghid Complet: Asigurări Business", desc: "top pentru tine 5 riscuri pe care IMM-urile românești le ignoră și cum să le transferi inteligent.", type: "PDF Guide", color: "bg-indigo-50 text-indigo-700" },
